...
from event.observers.click_observer import ClickObserver
from event.observers.music_notes import MusicNotes
from event.subjects.song_data import SongData
from song.song import Song
from song.song import MingusSong
from song.song import UltraStarFile
from menus.menu import Menu
from menus.button import MenuButton
from menus.text import MenuText
from menus.input_field import InputField
from event.keyboard_event import KeyboardEvent
from event.song_event import SongEvent
from song.song_segment import SongSegment
...
#        self.txt_input.label.visible = 0
    ...
    def setup(self):
        ...
        cube = MainCubeObserver(None, \
                        song_bar_color)

        self.music_notes = MusicNotes(None)
