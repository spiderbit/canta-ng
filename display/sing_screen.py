...
from event.song_event import SongEvent
from event.keyboard_event import KeyboardEvent
from event.subjects.song_data import SongData
from event.observers.lyrics_observer import LyricsObserver
from event.observers.main_cube_observer import MainCubeObserver
from event.observers.sing_cube_observer import SingCubeObserver
from event.observers.debug_widget import DebugWidget
from event.observers.resultview import ResultView
from event.observers.pos_cube_observer import PosCubeObserver
from event.observers.music_notes import MusicNotes
from event.observers.time_label import TimeLabel
from event.observers.pause import Pause
from game import Game
from song.song import Song
from menus.menu import Menu
from menus.button import MenuButton
...
class SingScreen(Menu):
    ...
    def show(self, args):
        ...
        pos_bar = PosCubeObserver(None,
                                  None)

        # Observer for the song time:
        time_label = TimeLabel(None)
        ...
        self.keyboard_event = KeyboardEvent(None)
        ...
        self.song_event = SongEvent(self.song, None,\
        ...
        self.player.play()
#        while self.song.line_nr < len(self.song.lines)-3:

        # while not self.song.end:
        #     # print (self.player.get_pos())
        #     self.song_event.begin_round()
