...
from display.properties import DisplayProperties
       ...
       # Options parent menu:
        ...
        for k, v in self.config.iteritems():
            ...
            for key, value in v.iteritems():
                # dont know why it does not find this keys but stop the loop on them for now.
                if key in ['resolution_y', 'helper']:
                    break
