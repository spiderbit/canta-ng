...
from menus.item_group import MenuGroup
from menus.browser import MenuBrowser
from menus.text import MenuText
from song.song_editor import SongEditor
from display.sing_screen import SingScreen
from song.song_manager import SongManager
from display.language import LocaleManager
import gettext
_ = gettext.gettext
...
#        self.camera = camera
        ...
        # Sing screen:
        self.sing_screen = sing_screen = SingScreen(app_dir=self.core.app_dir, main_menu=self, \
                    camera=None, theme_mgr=None, \
...
#            from player.gst_player import GSTPlayer
            from player.dummy_player import DummyPlayer as GSTPlayer
