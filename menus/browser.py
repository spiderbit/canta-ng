...
class MenuBrowser(MenuBrowserPresentation):
    def __init__(self, default_manager, widget_properties, sing_screen,\
        ...
        self.config_path = os.path.join(os.environ['HOME'], '.canta')
...
#        self.choose_base_button.label = song_manager.name
    ...
    def reload_view(self, direction, pos=None):
        ...
        song_manager = self.song_managers[0]
        #print (self.song_managers)
        song_manager.directory.name = "/home/black/.canta/songs"
        song_manager.search()
        print (song_manager.browsable_items)
#        song_manager = self.song_managers[0]
...
#            print (song_manager)
        ...
        entry = song_manager.browsable_items \
            [list(song_manager.browsable_items.keys())[song_manager.current_entry]]
        if 'selected_entry' in self.__dict__:
        ...
        print ("before-song-show")
        print (self.selected_entry)
        self.selected_entry.start_start_screen(args=[self.selected_entry.song, None])
